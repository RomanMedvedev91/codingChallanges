...
const duplicateEncode = require("../14_6kyu-dublicateEncoder");
...
describe("Duplicate Encoder", () => {
  it("Testing for fixed tests", () => {
    ...
    assert.strictEqual(duplicateEncode("Supralapsarian"), ")()))()))))()(", "Incorrect answer for 'Supralapsarian' - should ignore case");
